...
def train_network(model, criterion, optimizer, tloader, vloader, epochs = 3, print_every=20, power='gpu'):
    '''
    ...
    print("Dear User I am the ulitmate NN machine trained your model. It required")
    print("----------Epochs: {}------------------------------------".format(epochs))
    print("----------Steps: {}-----------------------------".format(steps))
    print("That's a lot of steps")


def save_checkpoint(model,traindata, path='checkpoint.pth', structure ='densenet121', hidden_layer1=120,dropout=0.5,lr=0.001,epochs=12):
    '''
